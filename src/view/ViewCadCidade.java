...
public class ViewCadCidade extends javax.swing.JFrame {
    ...
    private ControllerCadCidade cCadCidade;
    ...
    public ViewCadCidade() {
        ...
        mCadCidade = new ModelCadCidade();
        cCadCidade = new ControllerCadCidade();
    }
    ...
    private ModelCadCidade montarCidade(String funcao){
	//modelo
